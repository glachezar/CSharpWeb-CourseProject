...
namespace MyGarage.Data.Migrations
{
    ...
    [Migration("20230803085347_someChanges")]
            ...
            modelBuilder.Entity("MyGarage.Data.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("be5f0ac1-b76b-415c-885c-a926f293c924"),
                        ...
                        new
                        {
                            Id = new Guid("7fe870fa-c2b7-4868-8fa9-c568d4f1d986"),
                            Email = "Peshov@mcg.bg",
                            Name = "Pesho",
                        ...
                        new
                        {
                            Id = new Guid("920ebe5e-2296-4e30-8275-f72ae04dc508"),
                            Email = "Ivanov@mcg.bg",
                            Name = "Ivan",
                            PhoneNumber = "0888100200",
                            Surname = "Ivanov"
            ...
            modelBuilder.Entity("MyGarage.Data.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2813f948-4bd7-481a-a3a4-03766fc13f4f"),
                            IsActive = true,
                            JobName = "Oil change",
                            Price = 50.00m
                        },
                        new
                        {
                            Id = new Guid("6f6ec6bf-d253-4d73-9aa7-a2fba42e4907"),
                            IsActive = true,
            ...
            modelBuilder.Entity("MyGarage.Data.Models.JobCard", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 3, 8, 53, 46, 448, DateTimeKind.Utc).AddTicks(6419));
            ...
            modelBuilder.Entity("MyGarage.Data.Models.Mechanic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aefb1d99-b762-4b2e-a96a-0b2442bcbbc5"),
                            IsActive = true,
                            Name = "Ivan",
                        ...
                        new
                        {
                            Id = new Guid("243d161f-da84-484a-aa08-55a5f44a18aa"),
                            IsActive = true,
                            Name = "Petar",
            ...
            modelBuilder.Entity("MyGarage.Data.Models.Part", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a046a0f-8347-45ca-a673-206743a789b5"),
                            IsActive = true,
                            PartName = "Wishbone",
                        ...
                        new
                        {
                            Id = new Guid("23f83042-5b91-4aeb-88eb-dd44fbd3fe4e"),
                            IsActive = true,
            ...
            modelBuilder.Entity("MyGarage.Data.Models.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4f6749b-83f8-4fdf-87fa-97b0afcf625d"),
                        ...
                        new
                        {
                            Id = new Guid("8ece19fc-eb8f-4e95-b3b8-01bb3e1abed6"),
